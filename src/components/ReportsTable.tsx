...
const ReportsTable = () => {
  ...
  const selectedCohort = mockCohorts.find(cohort => cohort.id === selectedCohortId);
    ...
    <div className="p-6">
      ...
      {selectedCohort ? (
        learners.length > 0 ? (
          ...
          <p className="text-gray-500 text-center mt-10">No report data available for this cohort.</p>
        )
      ) : (
